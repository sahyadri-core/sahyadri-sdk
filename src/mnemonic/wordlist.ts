 ...
 * Standard wordlist for mnemonic generation
 */
...
export const wordlist = [
  ...
  "blow", "blue", "blur", "board", "boat", "body", "boil", "bomb",
  ...
  "chronic", "chunk", "churn", "citizen", "city", "civil", "claim", "clap",
  ...
  "dizzy", "doctor", "document", "dog", "doll", "domain", "donate", "donkey",
  "donor", "door", "dose", "double", "draft", "dragon", "drama", "drastic",
  ...
  "edit", "educate", "effort", "egg", "eight", "either", "elder", "electric",
  "elegant", "element", "elephant", "elevator", "elite", "else", "embark", "embody",
  "embrace", "emerge", "emotion", "employ", "empower", "empty", "enable", "encourage",
  ...
  "frozen", "fruit", "fuel", "funny", "furniture", "further", "future", "gadget",
  ...
  "gift", "giggle", "ginger", "girl", "give", "glad", "glance", "glare",
  ...
  "inquiry", "insane", "inside", "install", "intense", "interest", "invite", "involve",
  ...
  "manual", "maple", "marble", "march", "margin", "marine", "master", "match",
  ...
  "neutral", "never", "news", "next", "nice", "night", "noise", "nomad",
  ...
  "park", "parrot", "party", "pass", "patch", "path", "patient", "pattern",
  "pause", "pave", "payment", "peach", "pear", "peasant", "pelican", "pen",
  ...
  "remember", "remind", "remove", "render", "rent", "repair", "repeat", "replace",
  "report", "require", "rescue", "resemble", "resist", "resource", "response", "result",
  "retire", "retreat", "return", "reunion", "reveal", "review", "reward", "ribbit",
  "ribbon", "rice", "rich", "ride", "ridge", "rifle", "right", "rigid",
  "ring", "riot", "ripple", "risk", "ritual", "rival", "river", "road",
  "roast", "robot", "robust", "rocket", "romance", "roof", "rookie", "room",
  "rose", "rotate", "rough", "round", "route", "royal", "rubber", "rude",
  "rug", "rule", "run", "runway", "rural", "sad", "saddle", "safety",
  ...
  "slide", "slight", "slim", "slogan", "slot", "slow", "small", "smart",
  "smile", "smoke", "smooth", "snack", "snake", "snap", "sniff", "snow",
  "soap", "soccer", "social", "sock", "soda", "soft", "solar", "soldier",
  "solid", "solution", "someone", "song", "soon", "sorry", "sort", "soul",
  "sound", "soup", "source", "south", "space", "spare", "special", "species",
  "speed", "spell", "spend", "sphere", "spice", "spider", "spin", "spirit",
  ...
  "surprise", "survey", "switch", "symbol", "symptom", "syrup", "system", "table",
  "tackle", "tag", "tail", "talent", "talk", "tank", "tape", "target",
  "task", "taste", "taxi", "teach", "team", "tell", "ten", "tenant",
  ...
  "urge", "use", "used", "useful", "usual", "utility", "vacant", "vacuum",
